package com.wantech.noshame.fAQs.data.dataSource
...
object FAQS {
    val faqs = listOf(
        ...
        FAQ(
            question = "How does my menstrual cycle change as I get older?",
            answer = "Your cycles may change in different ways as you get older. Often, periods are heavier when you are younger (in your teens) and usually get lighter in your 20s and 30s. This is normal.\n" +
                    "\n" +
        ...
        FAQ(
            question = "Why should I keep track of my menstrual cycle? ",
            answer = "If your periods are regular, tracking them will help you know when you ovulate, when you are most likely to get pregnant, and when to expect your next period to start.\n" +
                    "\n" +
        ...
        FAQ(
            question = "How can I keep track of my menstrual cycle? ",
            answer = "You can keep track of your menstrual cycle by marking the day you start your period on a calendar. After a few months, you can begin to see if your periods are regular or if your cycles are different each month.\n" +
                    "\n" +
        ...
        FAQ(
            question = "When does a girl usually get her first period? ",
            answer = "The average age for a girl in the United States to get her first period is 12.6 This does not mean that all girls start at the same age.\n" +
                    "\n" +
        ...
        FAQ(
            question = "What is a normal amount of bleeding during my period? ",
            answer = "The average woman loses about two to three tablespoons of blood during her period.8 Your periods may be lighter or heavier than the average amount. What is normal for you may not be the same for someone else. Also, the flow may be lighter or heavier from month to month.\n" +
                    "\n" +
